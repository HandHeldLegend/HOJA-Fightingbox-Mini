...
#define PGPIO_BTN_A    5  // 1K
#define PGPIO_BTN_B    6  // 2K
#define PGPIO_BTN_X    1  // 1P
#define PGPIO_BTN_Y    2  // 2P

#define PGPIO_BTN_L   4   // 4P
#define PGPIO_BTN_R   3   // 3P
#define PGPIO_BTN_ZL  8   // 4K
#define PGPIO_BTN_ZR  7   // 3K
